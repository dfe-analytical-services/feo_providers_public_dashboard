...
test_that("{shinytest2} recording: feo_providers_public_dashboard", {
  app <- AppDriver$new(test_path("../.."),
    ...
    height = 868, width = 1203, load_timeout = 360000
  )
  app$set_inputs(selectUKPRN = "AYLESBURY COLLEGE")
  app$expect_values()
  app$expect_values()
  app$expect_values(output = "table_04")
  app$set_inputs(tabsetpanels = "Benefit Status")
  app$set_inputs(selectProvision01 = "Education & Training")
  app$expect_values(output = "table_01")
  app$set_inputs(tabsetpanels = "Community Learning")
  app$expect_values(output = "table_03")
  app$set_inputs(navlistPanel = "User guide")
  app$expect_values()
})


test_that("{shinytest2} recording: feo_providers_public_dashboard_test", {
  app <- AppDriver$new(test_path("../.."),
    variant = platform_variant(), name = "feo_providers_public_dashboard_test",
    height = 868, width = 1203, load_timeout = 360000
  )
