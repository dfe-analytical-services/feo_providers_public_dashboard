user_guide_panel <- function() {
  tabPanel(
    ...
    gov_main_layout(
      gov_row(
        column(
          12,
          heading_text(
            "Further Education Outcomes Provider data dashboard",
            level = 1,
            size = "l"
          ),
          heading_text("Introduction", level = 2, size = "m"),
          gov_text(
            "This app gives users an interactive tool to access the provider data from DfE's Further Education Outcomes publication,
          ...
          gov_text(
            "This dashboard accompanies the Further Education Outcomes publication by the Department for Education, acting as
             an interactive tool to access outcomes data for individual providers."
          ),
          gov_text(
            "The data presented in this dashboard is only a subset of the full dataset provided in the publication."
          ),
          gov_text(
          ...
          gov_text(
            "Further education outcomes (FEO) shows the percentage of further education
          ...
          gov_text(
            "This publication reports outcomes by various learner demographics and type
          ...
          gov_text(
            "The Longitudinal Education Outcomes (LEO) dataset is used, which looks at how
    learners move through education and into the labour market by bringing together:"
          ...
          gov_text(
            "All learner counts reported here relate to those learners for whom a match was found in the LEO data,
    therefore the counts will not match headline achievements in the FE & Skills National Statistics release."
          ...
          gov_text(
            "In addition to the headline measures presented in this publication, further
          ...
          gov_text(
            "A number of detailed breakdowns using this data have been signposted
          ...
          gov_text(
            "The outcomes reported in the commentary are presented as raw figures.
          ...
          gov_text(
            "Full details on rounding and suppression are available in the accompanying methodology documentation found
            on the publication website."
          ),
          gov_text(
            "Any percentage point (ppt) changes reported that appear to mismatch the percentages provided
